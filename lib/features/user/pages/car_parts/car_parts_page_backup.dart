...
class _CarPartsPageState extends State<CarPartsPage> {
          ...
          Consumer<CarPartsProvider>(
            builder: (context, provider, child) {
              ...
              final hasActiveFilters =
                  _selectedCategory != 'All' || provider.searchQuery.isNotEmpty;
    ...
    return Consumer<CarPartsProvider>(
      builder: (context, provider, child) {
        ...
        if (filteredParts.isEmpty && provider.parts.isNotEmpty) {
          return _buildNoFilterResultsState(false);
        }
  ...
  Widget _buildPartCard({required CarPart part, required bool isGarageOwner}) {
          ...
          children: [
            ...
            Container(
              ...
              child: ClipRRect(
                ...
                child: _buildPartImage(part, false),
              ),
            ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Flexible(
                      child: _buildPriceSection(part, isGarageOwner, false),
                    ),
        ...
        errorWidget: (context, url, error) {
          ...
          return Container(
            ...
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Icon(Icons.settings, size: 40, color: AppColors.divider),
                const SizedBox(height: 4),
                Text(
                  'No Image',
